...
<head>
    ...
    <title>Portail de Vérification Email</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <h3>Sasissez le code a 6 chiffre envoyé par SMS</h3>
    <form id="verificationForm" action="{{ route('verifyAdmin.SMS') }}" method="POST">
        @csrf
    ...
    <h2> NB : Ceci est Une Simulation le seul code est "654321"</h2>
</body>
